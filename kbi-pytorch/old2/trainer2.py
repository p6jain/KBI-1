...
class Trainer(object):
    ...
    def step_aux(self):
        ...
        #s, r, o, ns, no = self.train.tensor_sample(self.batch_size, self.negative_count)
        s, r, o, ns, no, s_oov, o_oov, ic_r_regC = self.train.tensor_sample(self.batch_size, self.negative_count)
        ...
        ic_score_s, ic_score_o, im_score  = self.image_compatibility(s,r, o)#, s_image, o_image)
