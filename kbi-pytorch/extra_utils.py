...
def get_entity_relation_id_neg_sensitive(mapping):
    em_path = "data/yago/image/entity_map.txt"
    ter_path = "data/yago/image/type_entity_range.txt"
    if check_exists(em_path) and check_exists(ter_path):
        ...
        f_em=open("data/yago/image/entity_map.txt","w")
        f_ter=open("data/yago/image/type_entity_range.txt","w")
